<rn:widget path="custom/fy15/FixedSupportSidebar" />
	<div id="rn_Window">
		<rn:widget path="custom/fy15/SmartlyHeader" />
		<div id="rn_Container" class="rn_ThemeLight">
			<rn:condition hide_on_pages="landing, products/list, products/overview, checkout, payment, payment_confirm,account/appointment/overview">
				<div id="rn_NavigationBar">
					<div>
						...
						<ul id="rn_MainNav">
							...
							<li><a href="/app/ask">#rn:msg:ASK_QUESTION_LBL#</a></li-->
							<!-- 
            ...
            <rn:condition show_on_pages="products/list, products/overview">
				<div id="rn_Page" class="rn_NoBorder">
            <rn:condition_else />
            	<div id="rn_Page">
            </rn:condition>
				<rn:condition hide_on_pages="home,landing, products/list, products/detail, checkout, payment, payment_confirm,  account/questions/list,social/moderate/comment,social/moderate/question,social/moderate/user">
