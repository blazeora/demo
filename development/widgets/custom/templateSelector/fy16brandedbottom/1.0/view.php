				...
				<rn:condition hide_on_pages="home,landing, products/list, products/detail, checkout, payment, payment_confirm,    account/questions/list,public_profile,social/moderate/comment,social/moderate/question,social/moderate/user">
					<div id="rn_Sidebar">
                        ...
                        <rn:condition show_on_pages="il">
							<div id="rn_SidebarNavigation" class="rn_Card">
							<rn:widget path="custom/fy15/SidebarNavigation" show_aaq="true" show_chat="true" show_community="true" show_c2c="true" />				<rn:condition show_on_pages="answers/detail">
                        </rn:condition>
		...
		<rn:widget path="custom/Branding/BrandingFooter" />
