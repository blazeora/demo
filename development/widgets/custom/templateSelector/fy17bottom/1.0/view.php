				...
				<rn:condition hide_on_pages="home,landing, products/list, products/detail, checkout, payment, payment_confirm,    account/questions/list,public_profile,social/moderate/comment,social/moderate/question,social/moderate/user,products/overview">
					<div id="rn_Sidebar">
...
<rn:widget path="custom/fy15/SmartlyFooter" />
